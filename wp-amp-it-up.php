...
Plugin URI: https://www.amp-cloud.de/amp-plugins/wordpress/plugin-amp-wordpress.php
										...
										// Prüfen, ob Datei im Cache ist
											...
											if(file_exists("".$urlCACHEdatei.""))
											{
												...
												// Datei-Datum prüfen
													...
													$dateiTIME_diff		= ( 60 * 60 * 72) ; 						// in Sekunden (alle 3 Tage)
					...
					// Alte Cache-Dateien löschen
						...
						// Prüfen wann alte Cache-Dateien zu letzt gecheckt/gelöscht wurden
							...
							if(file_exists("".$urlCHECK_absolute.""))
							{
								...
								$zeitDIFFmax	= ( 60 * 60 * 72 ) ; 				// in Sekunden (alle 3 Tage)
						...
						// Alte Cache-Datein löschen
							...
							if($delSTATUS == true)
							{
								...
								$cachetime_diff		= ( 60 * 60 * 24 * 3 ); 		// in Sekunden (einmal alle 3 Tage)
			...
			// Ads.txt prüfen
				...
				if($checkSTATUS == true)
				{
					...
					// Setze PUB ID - GOOGLE
						...
						{
							$zeileADD1					= "# easy AMP Plugin - GOOGLE";
							$zeileADD2					= "google.com, ".$searchSTRING." RESELLER, f08c47fec0942fa0";
					...
					/*
						//	List
							...
							$zeileADD					= array();
							$zeileADD[]					= "# easy AMP Plugin - SOVRN";
							$zeileADD[]					= "lijit.com, 429064, DIRECT, fafdf38b16bf6b2b #SOVRN";
							$zeileADD[]					= "lijit.com, 429064-eb, DIRECT, fafdf38b16bf6b2b #SOVRN";
							$zeileADD[]					= "openx.com, 538959099, RESELLER, 6a698e2ec38604c6";
							$zeileADD[]					= "pubmatic.com, 137711, RESELLER, 5d62403b186f2ace";
							$zeileADD[]					= "pubmatic.com, 156212, RESELLER, 5d62403b186f2ace";
							$zeileADD[]					= "rubiconproject.com, 17960, RESELLER, 0bfd66d529a55807";
							$zeileADD[]					= "appnexus.com, 1019, RESELLER, f5ab79cb980f11d1";
						...
						//	Add
							...
							{
								$zeileADDTEXT			= "".file_get_contents("".$urlADS_absolute."")."";
								$zeileADDTEXT			= "".str_ireplace( "".$zeileADD."" , ""			, "".$zeileADDTEXT."" )."";
								$zeileADDTEXT			= "".str_ireplace( "".$zeileADD."" , ""			, "".$zeileADDTEXT."" )."";
								$zeileADDTEXT			= "".$zeileADDTEXT."".$zeileADD."";
								$zeileADDSTATUS			= amp_cloud_set_datei("".$urlADS_absolute.""	, "".$zeileADDTEXT."");
							}
					*/
					...
					// Speicher freigeben
						...
						unset( $zeileDEL , $zeileADD , $zeileADD1 , $zeileADD2 , $zeileIST , $zeileADDTEXT , $zeileADDSTATUS , $searchSTRING );
				}	
		}
